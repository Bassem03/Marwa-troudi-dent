            ...
            <div className="container mx-auto px-6 relative z-10">
                ...
                <div className="grid lg:grid-cols-2 gap-12 items-start">
                    ...
                    >
                        ...
                        <form className="space-y-6">
                            ...
                            <div>
                                ...
                                <input type="tel" className="w-full px-6 py-4 rounded-2xl bg-slate-50 border border-slate-100 focus:outline-none focus:ring-2 focus:ring-primary focus:bg-white transition-all text-slate-800 font-medium" placeholder="27 622 668" />
                            </div>
                    ...
                    >
                        {/* Info Cards - Stacked */}
                        {[
                            { icon: Phone, title: "Appelez-nous", val: "+216 27 622 668", sub: "Lun-Ven 8h-18h", color: "bg-blue-100 text-blue-600" },
                            { icon: Mail, title: "Email", val: "Amani-Zerelli@gmail.com", sub: "Réponse sous 2 heures", color: "bg-emerald-100 text-emerald-600" },
                            { icon: MapPin, title: "Visitez-nous", val: "38 Rue Mouawiya Ibn Abi Sofiene", sub: "Ariana", color: "bg-purple-100 text-purple-600" }
                        ].map((item, i) => (
                            <motion.div
                                key={i}
                        ...
                        <div className="w-full h-80 bg-slate-200 rounded-[2rem] overflow-hidden relative shadow-lg border-4 border-white">
                            <iframe
                                title="Map Location"
                                src="https://maps.google.com/maps?width=100%25&amp;height=600&amp;hl=en&amp;q=38%20Rue%20Mouawiya%20Ibn%20Abi%20Sofiene,%20Ariana+(Cabinet%20dentaire%20Dr.%20Amani%20Zerelli)&amp;t=&amp;z=15&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"
                                width="100%"
                                height="100%"
                                style={{ border: 0 }}
                                allowFullScreen=""
